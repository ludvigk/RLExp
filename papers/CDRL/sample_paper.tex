...
Equation~\ref{eq:luddeflow_inv_grad} show the closed form inverse and gradient
respectively.
...
\begin{equation}
  ...
  (z^\prime - d) e^{\lvert z^\prime - d \rvert} \sign{(x - d)}}{w \lvert
  z^\prime - d \rvert ((e^b + 1)e^{\lvert z^\prime - d \rvert} - 1)}
