...
The disadvantage of this is that \(p(\bm{w})\) only acts as a regularizer, and cannot be
used to incorporate actual prior knowledge. Any prior knowledge we might have about the
function we are finding would be very difficult to translate into a prior distribution
in the weight space.
